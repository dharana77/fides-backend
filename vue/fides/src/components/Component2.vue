<template>
    <div id="component2">
      ...
      <div id="component2-box2" class="animate__animated animate__flipInX">
...
You not only can do direct investment but also you can do indirect investment.</p>
      ...
      <div id="component2-box3" class="animate__animated animate__flipInY">
...
Also, this will allow us to do more effective communication in DAO.</p>
      ...
      <div id="component2-box4" class="animate__animated animate__flipInY">
